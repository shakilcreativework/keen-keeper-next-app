...
const FriendsCount = () => {
    ...
    return (
        <div>
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5 my-8 lg:my-10 lg:gap-6">
                <div className="flex flex-col justify-center items-center gap-2 bg-white rounded-md p-6">
                    <h3 className="text-3xl text-[#244d3f] font-semibold">10</h3>
